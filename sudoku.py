#The valid() function is based on this paper: https://www.lri.fr/~conchon/mpri/weber.pdf
...
def sudoku_clauses():
    ...
    Sudoku puzzle at hand. I believe a clause is like a possibility.
    """
    res = []
...
def solve(grid):
    ...
    for i in range(1, 10):
        for j in range(1, 10):
            d = grid[i - 1][j - 1]
            #We could also remove all variables for the known cells (which would be more efficient as of less data to loop about).However I believe it is simpler to not to do that.
            if d:
...
def test():
    ...
    #Expert level Sudoku problem generated by the IOS Sudoku game on app store by Easybrain
